...
export class PrintMiTicket implements OnInit {
  ...
  getSaleTotals(sale): any {
    let totals = sale.mis.map((x) => {
      ...
      var a = {
        ...
        subtotal: subtotal,
        saving: (x.qty * x.mi.price) - x.sale_price,
        total: x.qty * x.mi.price,
